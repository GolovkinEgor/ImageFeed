...
import UIKit
    ...
    final class ProfileViewController: UIViewController {
        ...
        override func viewDidLoad() {
            ...
            labelTag.font = UIFont.systemFont(ofSize: 13)
            ...
            labelTag.widthAnchor.constraint(equalToConstant: 99).isActive = true
            labelTag.heightAnchor.constraint(equalToConstant: 18).isActive = true
